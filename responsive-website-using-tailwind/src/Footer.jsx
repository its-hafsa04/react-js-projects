...
const Footer = () => {
  return (
    <div className='max-w-[1240px] mx-auto py-10 px-4 grid lg:grid-cols-3 gap-8 bg-gray-400'>
      <div>
        <h1 className='w-full text-3xl font-bold text-orange-600'>HaSa Tech.</h1>
        <p className='py-4'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Id odit ullam iste repellat consequatur libero reiciendis, blanditiis accusantium.</p>
        <div className='flex justify-between md:w-[75%] my-6'>
          <FaFacebookSquare size={30} color='blue'/>
          <FaInstagram size={30} color='purple'/>
          <FaTwitterSquare size={30} color='blue'/>
